  ...
  const groups: ExcelGroup<FuelMonthlyRow>[] = [
    {
      ...
      columns: [
        ...
        { id: "type_cuve1", header: "Type Cuve", width: 110, render: (r) => tankType(primaryGe(r)?.tank_connected) },
        ...
        { id: "type_cuve2", header: "Type Cuve", width: 110, render: (r) => tankType(secondGe(r)?.tank_connected) },
